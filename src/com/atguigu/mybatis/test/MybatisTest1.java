...
public class MybatisTest1 {
    ...
    public void testCacheLevel1() throws IOException {
        ...
        try{
            ...
            print(emp1);
            //session.clearCache();
            Employee emp2 = mapper.getEmpByIdStep(1);
            print(emp2);

            Assert.assertTrue(Objects.equals(emp1, emp2));
        }catch (Exception e)
        {
            e.printStackTrace();
            Assert.fail();
    ...
    public void testCacheLevel2() throws IOException {
        ...
        try{
            ...
            EmployeeMapperPlus mapper2 = session2.getMapper(EmployeeMapperPlus.class);
            Employee emp1 = mapper1.getEmpByIdStep(1);
            print(emp1);
            session1.close();

            Employee emp2 = mapper2.getEmpByIdStep(1);
            print(emp2);
    ...
    public void testPageHelper() throws IOException {
        ...
        SqlSession session1=sqlSessionFactory.openSession();
        try{
            EmployeeMapperDynamicSql mapper1 = session1.getMapper(EmployeeMapperDynamicSql.class);
            Page<Object> page = PageHelper.startPage(5, 3);
            List<Employee> emps = mapper1.getEmpsByConditionChoose(null);
            print(emps);
